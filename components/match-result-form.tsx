...
import { submitGameResult } from "@/lib/api" // Use the updated API function
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function MatchResultForm({ matchId, userId, gameType, opponent, onSuccess }: MatchResultFormProps) {
  ...
  // Update the handleSubmit function to use the Supabase client
